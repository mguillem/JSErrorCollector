...
public class SimpleTest {
    ...
    private final JavaScriptError errorSimpleInFrameHtml = new JavaScriptError(
            errorSimpleHtml.getErrorMessage(),
            errorSimpleHtml.getSourceName(),
            errorSimpleHtml.getLineNumber(),
            errorSimpleHtml.getConsole(),
            errorWithNestedFrameHtml.getPageUrl());
    ...
    public void errorInNestedFrame() throws Exception {
        final List<JavaScriptError> expectedErrors = Arrays.asList(errorWithNestedFrameHtml, errorSimpleInFrameHtml);
